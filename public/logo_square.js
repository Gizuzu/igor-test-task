(function (cjs, an) {
  ...
  (lib.ысысвмама_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhEBUQhKgTAAhMQAAgrAdgcQAcgdArAAIBSAAQArAAAeAdQAeAeAAArQAAApgeAeQgeAegrAAIg0AAIg4AUg"
      );
  ...
  (lib.ывсвсвсвсв_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgmBwQgsAAgegdQgegeAAgrQAAgpAegeQAegeAsAAIAzAAIA4gUIAAAcQBKATAABMQAAArgcAcQgdAdgqAAg"
      );
    this.shape.setTransform(14.3, 11.225);
  ...
  (lib.тиствсьтвсвсв_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgNAOQgFgGAAgIQAAgHAFgFQAGgGAHAAQAIAAAFAGQAGAFAAAHQAAAIgGAGQgFAFgIAAQgHAAgGgFg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "Ah8BbQgKAAgGgIQgGgHACgKIAeiMQACgHAFgFQAGgEAHAAIDbAAQAJAAAHAIQAGAHgCAKIgeCLQgCAHgFAGQgGAEgIAAg"
      );
    ...
    this.shape_2.graphics
      .f("#FFFFFF")
      .s()
      .p("Ah8ANQAAgLAIgGQAHgHAKgBIDgAAIAAAZg");
    ...
    this.shape_3.graphics
      .f("#ED6FBB")
      .s()
      .p("AgRAcQgFgCgDgEIgHgKIAVgqIABAAQAVgIAWAMIgnA8g");
    ...
    this.shape_4.graphics
      .f("#ED6FBB")
      .s()
      .p("AAGAOIgYgNIAJgPIAXANQAEABABADQABAEgCADQgCADgDABIgDABIgEgBg");
    ...
    this.shape_5.graphics
      .f("#ED6FBB")
      .s()
      .p("AAQATIgtgXIAIgQIAuAXQAHAFgDAIQgDAFgEAAIgGgCg");
    ...
    this.shape_6.graphics
      .f("#ED6FBB")
      .s()
      .p("AAUAWIg0gcIAIgQIA1AcQADACABADQABAEgBADQgCADgEABIgDABIgEgBg");
    ...
    this.shape_7.graphics
      .f("#ED6FBB")
      .s()
      .p("AASAQIgxgVIAXgMIAiARQAEACABAEQABADgCAEQgBADgEABIgDABIgEgCg");
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "AhlB+IhegrQgRgHgFgSQgFgSAKgQIBdiLQAMgVAWgNQAVgMAYAAIBrAAQAWAAASALQASAMAKAUIBVCxIglA3IhVioIAGDAIjNAYgAiEAaQgEAGACAGQACAHAGADIAZALIAAhJg"
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "ACeCqIhhj/QgfAIgoAHQhSAPg1AAQgdAAgYgXQgZgXAAggIAAgNIFggXQAYANACAbIBFErg"
      );
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        "ACmCtIhqkOIhUgsICKgfQAbAKAFAcIBaEzgAjsiPIB7ANIhUAugAhxiCIA2gcIAjARIg+AOgAgYiNg"
      );
    ...
    this.shape_11.graphics
      .f("#000000")
      .s()
      .p("Ag7ATIATglIAoAAQgCAHAEAGQADAFAIAAIAOgBQALgCAKAGQAJAGACAKg");
    ...
    this.shape_12.graphics
      .f("#000000")
      .s()
      .p("Ag7ATIATglIAoAAQgCAHADAGQAEAFAIAAIAOgBQALgCAJAGQAKAGADAKg");
  ...
  (lib.сскакк_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhEBUQhKgTAAhMQAAgrAcgcQAdgdArAAIBSAAQArAAAeAdQAeAeAAArQAAApgeAeQgeAegrAAIg0AAIg4AUg"
      );
  ...
  (lib.рывисрвис_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AALBZIg0AAQgrAAgegdQgegeAAgqQAAgqAegeQAegdArAAIBSAAQArAAAfAeQAeAeAAAqQAAAhgTAbQgTAbgfAKIAAAcg"
      );
  ...
  (lib.руфффв_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#000000")
      .s()
      .p("AgBAmQgIgYAEgWQAEgXAEgPIAFgKIAABxQgFgHgEgMg");
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AhPBBIgKgbQgPgoAUgmQAUgnArgLQAjgJAhAQQAhARAMAkQAEAMAAAGIgkADIgOgYIgFAZIg/AEIgqBiQgIgOgHgPg"
      );
    ...
    this.shape_4.graphics
      .f("#FFFFFF")
      .s()
      .p("AgMAEQgGgFAAgHIAlAAQAAAHgGAFQgFAFgIAAQgHAAgFgFg");
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "Ag6BrIAAgqIgZhIQgLglAUghIADgGQAPgYAbgKQAagLAaAIQAcAHASAWQASAWAAAXIABBBQAAASgMAMQgMANgSAAIghAAIgBAtIghARg"
      );
  ...
  (lib.всвсвс_мм_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAKBaIgzAAQgrgBgegdQgfgeABgpQAAgrAegeQAegeArAAIBSAAQArAAAfAfQAeAeAAArQAAAggTAbQgTAbgfAKIAAAdg"
      );
  ...
  (lib.всвсвс_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#ED6FBB")
      .s()
      .p("AgjAjIADgGQAjggAHgxIAAgDQABgGAFgDQAFgDAGACQAIACABAKQABA1gjAnIgXAcg");
    ...
    this.shape_1.graphics
      .f("#ED6FBB")
      .s()
      .p("AggAUIA0gwQAFgFAGAGQACACAAADQAAAEgCACIg0Awg");
  ...
  (lib.вмсвмс_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#ED6FBB")
      .s()
      .p("AgVBeIAAgkIArAAIAAAkgAgVAbIAAh4IArAAIAAB4g");
  ...
  (lib.вамамыыыы_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#ED6FBB")
      .s()
      .p("AgVBeIAAglIArAAIAAAlgAgVAbIAAh4IArAAIAAB4g");
    this.shape.setTransform(2.175, 9.375);

    this.timeline.addTween(
      cjs.Tween.get(this.shape)
        .wait(5)
        .to({ x: 12.175, y: 14.375 }, 0)
        .wait(5)
        .to({ x: 9.675, y: -0.625 }, 0)
        .wait(5)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.вака_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Ag5AoQgDgFACgGQACgFAFgDIADgBQAugSAWgrIAFgEIAjAFIgWAfQgeArgzALIgEABQgGAAgEgGg"
      );
    ...
    this.shape_1.graphics
      .f("#ED6FBB")
      .s()
      .p("AgTAkQgHgDAEgIIAhg+IAOAIIghA+QgDAFgEAAIgEgCg");
  ...
  (lib.Scene_1_Layer_5 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AlgIdIAAw4IFsAAQBBgBA6AOQA5AOApAgQAqAgAWA1QAWA1AABMQAABYgoA/QgpA/hSAXIAAADQBbAMA1BAQA1BBAABtQAABAgRA5QgRA6goArQgoArhAAZQhAAbhgAAgAiGF8IBVAAQBOAAAwgjQAxgjAAhdQAAgvgNggQgNgggWgRQgWgUgegHQgdgHglgBIheAAgAiGhgIA+AAQBbAAApggQApghAAhNQAAhOglgfQgngghQAAIhPAAg"
      );
  ...
  (lib.Scene_1_Layer_3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#F2F2F2")
      .s()
      .p("Ak0IdIAAw4IJbAAIAACzImCAAIAAD9IFqAAIAACyIlqAAIAAEjIGRAAIAACzg");
    this.shape.setTransform(286.8, 340.35);
  ...
  (lib.pers8_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgOAPQgGgGAAgJQAAgIAGgGQAGgGAIAAQAJAAAGAGQAGAGAAAIQAAAJgGAGQgGAGgJAAQgIAAgGgGg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AgVBUQghgIgVgcQgVgaAAgfQAAgaATgcQAJgOAKgJIAhBCIB6AZIgBAFIgDAOQgNAkggARQgVAKgXAAQgMAAgNgDg"
      );
    ...
    this.shape_2.graphics
      .f("#FFFFFF")
      .s()
      .p("AgRAJQAAgHAFgFQAFgFAHAAQAIAAAFAFQAFAFAAAHg");
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AgdB0QgagLgOgXIgEgFQgUghALgkIAZg8IAAgrIAigaIAjAaIABAvIAgAAQARAAAMAMQAMAMAAARIgBA1QAAAWgRAVQgSAWgbAIQgLADgLAAQgPAAgPgGg"
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AgLCbQgHgFAAgJIABh5QAAgIgGgGQgGgFgIAAQgHABgFAFQgGAFAAAIIAAAlQAAAHgEAFQgFAGgGABQgJABgGgFQgHgGAAgIIAAjYIC5AgIAACfQAAAHgFAGQgEAGgHABQgIABgHgFQgGgGAAgJIAAgtQAAgIgGgFQgGgGgHAAQgHAAgGAEQgGAFAAAGIAACbQAAAHgEAGQgEAFgHABIgDAAQgGAAgFgEg"
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AkNDYICgjWIAMjhIAPgFQBQgXBOAYIANAEIAUDfIChDYIgZAXIh6h/QgYgZgggOQgggNgjAAQgiAAggAOQggANgYAaIh6B/g"
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AALBCQgEgEgBgGIAAgCQgDgxgggjIgCgHIAQgeIAVAeQAfAqgGA0QgBAJgIACIgDAAQgEAAgEgCg"
      );
    ...
    this.shape_7.graphics
      .f("#ED6FBB")
      .s()
      .p("AARAeIgvgzIAMgLIAvA0QAFAFgGAGQgDACgDAAQgCAAgDgDg");
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "AgUBEQgIgCgCgJQgGg0AfgqIAVgeIAQAeIgCAHQggAjgDAxIAAACQAAAGgFAEQgEACgEAAIgCAAg"
      );
    ...
    this.shape_9.graphics
      .f("#ED6FBB")
      .s()
      .p("AgbAfQgGgGAFgFIAvg0IAMALIgvAzQgDADgDAAQgDAAgCgCg");
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        "AhdBQIgyhrQgJgTAMgRQAMgRAVACQAJABAHAFIBbA+IBbg+QAIgFAJgBQAVgCAMARQAMARgJATIgyBrg"
      );
  ...
  (lib.pers7_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ABHESQgOgsgGg9QgGg8ABhDIADg3IgxiuIgwCuIADA3QACBDgHA8QgGA9gOAsQgHAWgFAKIghgRIgJk4IAbj3IBagjIAHADIAIgDIBbAjIAaDuIgJFBIghARQgFgKgHgWg"
      );
    ...
    this.shape_1.graphics
      .f("#000000")
      .s()
      .p("AgxAQIALgiIAlACQgEAFAEAGQADAFAHAAIAMAAQALgBAHAEQAJAHACAJg");
    ...
    this.shape_2.graphics
      .f("#000000")
      .s()
      .p("AgxAOQADgKAJgEQAIgFAKACIANADQAGAAADgGQAFgFgDgGIAlABIAIAig");
  ...
  (lib.pers6_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#ED6FBB")
      .s()
      .p("AggAMIgCgPIAkgWIABAAQAUAEAMAVIg7Aag");
    ...
    this.shape_1.graphics
      .f("#ED6FBB")
      .s()
      .p("AAAANIgNgVIANgIIANAVQAEAGgHAFIgFABQgEAAgBgEg");
    ...
    this.shape_2.graphics
      .f("#ED6FBB")
      .s()
      .p("AAEAXIgWgpIAOgIIAWApQACACgBAEQgBADgDACIgEABQgEAAgDgEg");
    ...
    this.shape_3.graphics
      .f("#ED6FBB")
      .s()
      .p("AALAeQgEgBgBgDIgagvIAOgIIAaAvQACADgBADQgBADgDACIgEABIgCAAg");
    ...
    this.shape_4.graphics
      .f("#ED6FBB")
      .s()
      .p("AAEATIgWgpIATACIARAeQAEAIgHAEIgEABQgEAAgDgEg");
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AgJARQgHgEgCgIQgCgHAEgHQAEgGAIgDQAHgBAHADQAHAFACAIQACAGgEAHQgEAHgIABIgFABQgEAAgFgCg"
      );
    ...
    this.shape_7.graphics
      .f("#F5B940")
      .s()
      .p("AAFDyIgDgUQgFgsAFhTIAHhLIhaiLIArh7IBKAPIApDZQAHASgDAUIgXDWg");
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "AiMD7IAEg5QABggALgvQAJgxALgcIASgrIAEh0QABgwAcgoIAXgpICrAfIgEAIQgIAXg2ApIg1AkIhwFqg"
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AjUCGIAFgaQAKhABChuQAhg3AfgrIBKAbIAmA9IAUgSIAcAeQAKAJACAOIAKBqIA5hrIApASIhICVQgMAXgaABQgQAAgMgKQgMgKgCgQIgMhKIgfAbIg6Bjg"
      );
    ...
    this.shape_10.graphics
      .f("#FFFFFF")
      .s()
      .p("AgHAKQgGgDgBgHQgCgGADgGIAdAQQgEAGgHACIgFABQgDAAgEgDg");
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        "AhSAFQAHglAhgVQAhgUAkALQAhAKARAdQARAdgIAhIgDABQg6AJgygdIgFgDIg6AyQAAgZAGglg"
      );
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "AhlAbIAfgJIAOhGQAIghAfgRIAFgDQAWgMAZAEQAaAFASASQASATAEAaQAEAZgLARIgeA0IAAAAQgIAOgPAEQgPAEgOgIIgdgPIhMBDg"
      );
    ...
    this.shape_13.graphics
      .f("#5FD5FA")
      .s()
      .p("AAABFQgSAAgNgNQgNgMAAgTIAAhdIBZAAIAABdQAAATgNAMQgNANgTAAg");
    ...
    this.shape_14.graphics
      .f("#000000")
      .s()
      .p("Ag1AUIgMgOIApgbIAMALQAOALARAAIAPgCQALgBAKAFQAJAHACAMg");
    ...
    this.shape_15.graphics
      .f("#000000")
      .s()
      .p("Ag1AUIgMgOIApgbIAMAMQAOAJARABIAPgBQALgCAKAFQAJAHACALg");
  ...
  (lib.pers6_copy_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AhSAFQAHglAhgVQAhgUAkALQAhAKARAdQASAdgJAhIgDABQg6AJgygdIgFgDIg6AyQAAgZAGglg"
      );
    ...
    this.shape_14.graphics
      ...
      .s()
      .p(
        "ABWD7IgCgVQgGgrAFhTIAHhLIhaiMIhxFqIgxAAIADg5QACggAKgvQAKgxALgcIARgrIAEh0QABgwAcgoIAXgpIBgASIAKABIAEABIAEABIA5AKIApDZQAHATgDAUIgXDWg"
      );
  ...
  (lib.pers5_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AiBAzIA4gDIACgdQACghAfgXQAegYAmABQAfABAbATQAaAUALAdQAEAMABAPIgBALIkBAOg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AgNAOQgFgGAAgIQAAgHAFgGQAGgFAHAAQAIAAAGAFQAFAGAAAHQAAAIgFAGQgGAFgIAAQgHAAgGgFg"
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AhxBdQgIAAgHgFQgGgGgBgJIgPiNQgBgJAHgIQAGgHAKAAIEBAAQAKAAAGAHQAHAHgBAKIgQCNQAAAJgHAGQgGAFgIAAg"
      );
    ...
    this.shape_3.graphics
      .f("#000000")
      .s()
      .p("AgxgFQAKgGALABIAPACIALgCIA/AVIh5ABQACgLAJgGg");
    ...
    this.shape_4.graphics
      .f("#000000")
      .s()
      .p("Ag1AUIgMgOIApgaIAMALQAOAJARAAIAPgBQALgBAKAGQAJAGACALg");
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AhABLIiog1QgVgJgHgVQgHgXAMgUQAJgNAPgGQAOgGAQAEIBeAZIDXAAIBegZQAQgEAPAFQAPAGAIANQAMAUgHAXQgGAVgWAJIh5A2g"
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AgOAPQgGgGgBgJQABgIAGgGQAGgGAIgBQAJABAGAGQAHAGAAAIQAAAJgHAGQgGAHgJAAQgIAAgGgHg"
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "AAXALIgNAPQgIAKgNACQgNABgKgIIg+gsQAAgGAEgNQANglAigRQAhgQAlAJIAHACQAmANARAlQASAlgNAlIgBAAQgCAIgGAKIgaAug"
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AgLBiIgBgwIghAAQgSAAgMgNQgMgMAAgRIABg2QgBgXASgWQATgWAcgIQAagHAbAKQAaALAPAYIADAFQAVAhgLAmIgaA9IAAAsIgjAbg"
      );
  ...
  (lib.pers4_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgOAPQgGgHAAgIQAAgHAGgHQAGgGAIAAQAJAAAGAGQAGAHAAAHQAAAIgGAHQgGAGgJAAQgIAAgGgGg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AguBNQgigRgMgkIgEgOIAAgEIB6gaIAhhCIATAXQATAdAAAaQAAAegVAbQgVAbghAIQgNADgMAAQgWAAgVgKg"
      );
    ...
    this.shape_2.graphics
      .f("#FFFFFF")
      .s()
      .p("AgRAJQAAgIAFgEQAFgFAHAAQAHAAAGAFQAFAEAAAIg");
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AgWB3QgbgIgSgVQgSgVABgXIgBg0QAAgRAMgNQAMgMARAAIAgAAIABgvIAigaIAjAaIAAAsIAZA7QALAkgUAhIgEAFQgOAYgaAKQgPAGgPAAQgLAAgLgDg"
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AkNDYICgjWIAMjhIAPgFQBPgWBPAXIANAEIAUDfIChDYIgZAXIh6h/QgYgZgggOQgggNgjAAQgiAAggAOQggAOgYAZIh6B/g"
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AALBCQgFgDAAgGIAAgDQgDgwgggkIgCgGIAQgfIAVAeQAfAqgGA0QgBAKgIABIgEAAQgEAAgDgCg"
      );
    ...
    this.shape_6.graphics
      .f("#ED6FBB")
      .s()
      .p("AARAeIgvg0IALgKIAwAzQAFAGgGAGQgDACgCAAQgDAAgDgDg");
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "AgUBEQgJgBgBgKQgGg0AfgqIAVgeIAQAfIgCAGQggAkgDAwIAAADQAAAGgFADQgDACgEAAIgDAAg"
      );
    ...
    this.shape_8.graphics
      .f("#ED6FBB")
      .s()
      .p("AgbAfQgGgFAFgHIAvgzIAMALIgvA0QgDACgDAAQgDAAgCgCg");
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AhdBPIgzhqQgIgTAMgRQAMgRAVACQAJABAHAFIBbA+IBcg+QAHgFAJgBQAVgCAMARQAMARgIATIgzBqg"
      );
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        "AgCCfQgHgBgEgFQgFgGAAgHIAAicQAAgGgGgEQgFgEgHAAQgIAAgFAGQgGAFAAAIIAAAtQAAAJgGAFQgHAGgIgCQgHgBgEgFQgFgGAAgHIAAigIC5ggIAADYQAAAJgHAGQgGAFgJgBQgGgBgFgGQgEgGAAgHIAAgkQAAgIgFgFQgGgGgHAAQgIgBgGAGQgGAGAAAIIABB5QAAAIgHAGQgFAFgHAAIgCgBg"
      );
  ...
  (lib.pers2_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgMAOQgGgGAAgIQAAgHAGgFQAFgGAHAAQAIAAAGAGQAFAFAAAHQAAAIgFAGQgGAFgIAAQgHAAgFgFg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AhdBbQgIAAgGgEQgFgGgBgHIgfiLQgCgKAGgHQAHgIAJAAIDbAAQAHAAAFAFQAGAEABAHIAfCMQACAKgGAHQgHAIgJAAg"
      );
    ...
    this.shape_2.graphics
      .f("#FFFFFF")
      .s()
      .p("Ah8ANIAAgZIDgAAQAKABAIAHQAHAGAAALg");
    ...
    this.shape_3.graphics
      .f("#F8D04E")
      .s()
      .p("AgGg5IAEALQAEAPAEAXQAEAWgIAYQgDAMgFAIg");
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AAeB8IgWieIg+gEIgGgZIgNAYIglgDQAAgGAEgMQAMgkAigRQAggQAjAJQBHAFAZBdQAYBZgpAxQgrAIgLAAIgCAAg"
      );
    ...
    this.shape_6.graphics
      .f("#ED6FBB")
      .s()
      .p("AgggaQAWgMAVAIIABAAIAVAqIgIAKQgDAEgEACIgLAGg");
    ...
    this.shape_7.graphics
      .f("#ED6FBB")
      .s()
      .p("AgLAOQgEgBgCgDQgDgIAHgDIAYgNIAIAPIgXANIgEABIgDgBg");
    ...
    this.shape_8.graphics
      .f("#ED6FBB")
      .s()
      .p("AgXAUQgDgBgCgDQgCgDABgEQABgDAEgCIAugYIAIAQIguAYIgEABIgDgBg");
    ...
    this.shape_9.graphics
      .f("#ED6FBB")
      .s()
      .p("AgfASQgFgIAIgEIA1gcIAJAQIg1AcIgFABQgFAAgCgFg");
    ...
    this.shape_10.graphics
      .f("#ED6FBB")
      .s()
      .p("AgYARQgEgBgCgEQgCgDACgDQABgEADgCIAigRIAYAMIgyAVIgDACIgDgBg");
    ...
    this.shape_11.graphics
      .f("#FFFFFF")
      .s()
      .p("AgMAEQgGgEAAgIIAlAAQAAAIgGAEQgFAFgIAAQgHAAgFgFg");
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "AgLBrIgBgtIghAAQgRAAgNgNQgMgMAAgSIABhBQAAgXASgWQASgWAcgHQAagIAaALQAbAKAPAYIADAGQAUAggLAmIgZBIIAAAqIglARg"
      );
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        "AhnCKIAGjAIhVCoIglg3IBViyQAKgTASgMQASgLAWAAIBrAAQAZAAAVAMQAVAMAMAWIBdCLQAKAQgFASQgFASgRAHIheArIAAAkgABmA7IAZgLQAHgDABgHQACgHgEgFIgfgog"
      );
    ...
    this.shape_14.graphics
      .f("#000000")
      .s()
      .p("AjfCqIBFkrQADgbAYgNIFfAXIAAANQAAAggZAXQgYAXgdAAQg1AAhSgPIhHgPIhhD/g");
    ...
    this.shape_15.graphics
      ...
      .s()
      .p(
        "AjsCtIBbkzQAFgcAbgKICKAfIhUAsIhqEOgABxiCIB8gNIgnA7gAAZiNIAjgRIA1AcIgbADgABxiCg"
      );
    ...
    this.shape_16.graphics
      .f("#ED6FBB")
      .s()
      .p("Ag7ATQADgKAJgHQAKgFALACIAOABQAIAAAEgFQADgGgDgHIApAAIATAlg");
    ...
    this.shape_17.graphics
      .f("#ED6FBB")
      .s()
      .p("Ag7ATQADgLAJgGQAJgFAMACIAOABQAHAAAFgFQADgGgDgHIAoAAIATAlg");
  ...
  (lib.leg2_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ABdEyIiNkYIhRjoIBDhHIAIgBIAHgGIAogWIADCEIgBAAIABALIABAAIAcCmIAaAxQAeA9AUA5QAUA5AGAuQAEAXgBALg"
      );
  ...
  (lib.leg1_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ABQBhQgTgbgagqQgfgzgMgHQgEgCgBADIAAADIiABwIgEiDIChhbICBD+IggATQgNgNgUgbgAiNBhIAAgGIABAGg"
      );
  ...
  (lib.hzhzhzhz_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhQCiIgljKIgUCpIgrgwQgQgRADgYIAgh/QAMgmAOgPQARgSAbgCIBXgBIBWABQAcACARAPQARAQAKAiIAoCFQAEAWgQASIgqAwIgbioIgcDKg"
      );
  ...
  (lib.head_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgGAVQgJgDgEgIQgEgJADgHQADgJAJgEQAIgEAIADQAJADADAJQAEAIgDAIQgDAIgIAEQgFACgFAAIgGgBg"
      );
    ...
    this.shape_1.graphics
      .f("#FFFFFF")
      .s()
      .p("AgGANQgIgDgDgHIAhgQQAEAHgDAHQgDAHgHAEQgEACgDAAIgGgBg");
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AA+DcQgLgEgFgLIiIkgQgNgdAGggQAHghAagVQAcgXAjABQAjABAaAaQAJAJADAGIhoBYICBEPQAFAKgEALQgEALgLAFQgGADgGAAQgFAAgEgBg"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AgGBxIgOgiIg3g5QgagcAEgnIABgGQADgcAUgVQAUgVAcgFQAbgFAbAMQAaAMAJAVIAeA8IAAABQAHAQgGAPQgFARgQAIIgeANIASAnIgSAtg"
      );
  ...
  (lib.handhand_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgiAkIABgMQAAgMAGgMQAFgJAHgIIACgCIAYgfQADgFAFACQAEABABAEQABADgBADIgPAcIATARQALAKgGANIgHALQgIAMgMAGg"
      );
  ...
  (lib.hand2_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#5FD5FA")
      .s()
      .p("AguAQIBehcIAXAaIhlB7QgOAEgJAAQglAAAsg9g");
  ...
  (lib.hand1_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#5FD5FA")
      .s()
      .p("Ag4AKIBUhPQAuAGgRAiIhSBjQgxgLASgxg");
  ...
  (lib.frrfrfrf_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#000000")
      .s()
      .p("AgogQIAkgBQgCAGAEAGQADAFAGAAIANgDQAKgCAJAFQAIAFADAJIhjAEg");
  ...
  (lib.eecghhhh_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#000000")
      .s()
      .p("AgZBxIAAgsIA0AAIAAAsgAgZAhIAAiSIA0AAIAACSg");
  ...
  (lib.EDEGGG_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Ag1BcQgUgSAAgeQAAgTALgQQAMgPAQgIQAJgGAEgHQADgJAAgLIAxAAQAAAVgHAKQgJALgRAMQgLAHgEAIQgGAKAAAMQAAAMAHAIQAGAHAMAAQAKAAAGgGQAGgGABgMIAxAAIAAABQABAfgUAPQgVAQggAAQgjAAgUgSgAgShFIAAgoIAxAAIAAAog"
      );
  ...
  (lib.EDEDEDFEFE_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgeBuIAAgoIAxAAIAAAogAgeAwQAAgVAIgKQAGgKATgNQALgHAEgJQAHgJgBgMQABgMgIgIQgGgHgMAAQgJAAgHAGQgHAHAAALIgxAAIgBgBQABgfATgPQAVgQAgAAQAjAAAUASQAUARABAfQAAAUgMAOQgKAOgSAKQgJAHgDAGQgEAHAAANg"
      );
  ...
  (lib.EDEDEDEGGGG_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgeBuIAAgoIAxAAIAAAogAgeAwQAAgVAHgKQAIgKASgNQAKgGAGgJQAFgKAAgMQAAgNgGgHQgHgHgLAAQgLAAgGAGQgGAGgBAMIgxAAIAAgBQgBgeAUgQQAUgQAiAAQAiAAAUASQAVASAAAeQAAATgMAPQgKAPgSAJQgJAGgEAHQgDAIAAAMg"
      );
  ...
  (lib.dxcdcdc_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AggBzIAAgqIA0AAIAAAqgAggAyQAAgWAIgKQAJgMASgNQAKgGAGgKQAGgJAAgNQAAgOgHgHQgGgIgNAAQgKAAgHAHQgHAGAAANIg0AAIAAgBQAAghAVgQQAVgQAiAAQAlAAAVASQAVATAAAgQAAATgLARQgMAPgSAKQgKAGgEAIQgDAJAAALg"
      );
  ...
  (lib.dvvfvnnn_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#000000")
      .s()
      .p("AgxAOQACgJAJgFQAJgFAKACIAMACQAHABADgGQAEgFgDgGIAlABIAJAig");
    this.shape.setTransform(5, 1.825);
  ...
  (lib.ccece_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AggBzIAAgqIA0AAIAAAqgAggAyQAAgUAIgMQAHgKAUgOQALgHAGgKQAGgJAAgNQAAgNgHgIQgIgIgLAAQgKAAgIAHQgHAHAAAMIg0AAIAAgBQAAghAVgQQAVgQAjAAQAjAAAWATQAVASAAAgQAAATgLARQgNARgRAIQgKAHgDAHQgEAHAAANg"
      );
  ...
  (lib.bodyy_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgPAQQgGgHAAgJQAAgIAGgHQAHgGAIAAQAJAAAHAGQAGAHAAAIQAAAJgGAHQgHAGgJAAQgIAAgHgGg"
      );
    ...
    this.shape_1.graphics
      .f("#FFFFFF")
      .s()
      .p("AgNAEQgFgEAAgJIAlAAQAAAJgGAEQgFAGgIgBQgHABgGgGg");
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AhUDWQgIgJAAgLIAAk/QgBggAUgaQAUgbAggIQAjgJAgAQQAgAQAMAjQAEAMAAAGIiDAjIABEtQAAALgIAJQgIAIgMAAQgMAAgIgIg"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "Ag8BgIABgkIgZhKQgLgkAUgjIAEgFQAPgYAbgLQAagKAbAHQAcAHATAXQASAWgBAXIABBDQAAARgMANQgMAMgSABIghgBIAAArIgiAhg"
      );
    ...
    this.shape_4.graphics
      .f("#5FD5FA")
      .s()
      .p("AhoDWIgHkSIj3h3IAKgiIE7BmIBDAAIE7hmIAKAhIj3B4IgIESg");
    ...
    this.shape_5.graphics
      .f("#ED6FBB")
      .s()
      .p("AASAkQgwgWgVgvQgEgIAHgHQAFgEAGABQAFABAEAFIABACQAbAqAuANIAFAFIACAjg");
    ...
    this.shape_6.graphics
      .f("#ED6FBB")
      .s()
      .p("AghgCQgDgBgCgDQgBgDABgDQABgHAJACIBDAVIgFAPg");
    ...
    this.shape_7.graphics
      .f("#ED6FBB")
      .s()
      .p("AgyARIAFgFQAvgOAagpIABgCQAEgFAFgBQAGgBAFAEQAGAHgDAIQgWAwgvAVIgjAQg");
    ...
    this.shape_8.graphics
      .f("#ED6FBB")
      .s()
      .p("AgnAEIBEgVQAHgCADAHQACAHgHADIhEAVg");
  ...
  (lib.ысысвмама = function (mode, startPosition, loop) {
    ...
    lib.ысысвмама,
    new cjs.Rectangle(0, 0, 28.6, 22.5),
    null
  );
  ...
  (lib.сскакк = function (mode, startPosition, loop) {
    ...
    lib.сскакк,
    new cjs.Rectangle(0, 0, 28.7, 22.5),
    null
  );
  ...
  (lib.рывисрвис = function (mode, startPosition, loop) {
    ...
    lib.рывисрвис,
    new cjs.Rectangle(0, 0, 29.1, 22.9),
    null
  );
  ...
  (lib.рисорвисорв_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ y: 1.2 }, 14, cjs.Ease.quadInOut)
        .to({ y: 11.2 }, 15, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.рисорвисорв = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(29).call(this.frame_29).wait(1)
    );
  ...
  (lib.всвсвс = function (mode, startPosition, loop) {
    ...
    lib.всвсвс,
    new cjs.Rectangle(0, 0, 8.3, 13.4),
    null
  );
  ...
  (lib.ворсмовитсм_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ y: 21.2 }, 15, cjs.Ease.quadInOut)
        .to({ y: 11.2 }, 16, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.ворсмовитсм = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(31).call(this.frame_31).wait(1)
    );
  ...
  (lib.вмсвмс = function (mode, startPosition, loop) {
    ...
    lib.вмсвмс,
    new cjs.Rectangle(0, 0, 4.4, 18.8),
    null
  );
  ...
  (lib.вамамавм_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleX: 1.2232, scaleY: 1.2232, x: 14.35 }, 15)
        .to({ scaleX: 1, scaleY: 1, x: 14.3 }, 15)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.вамамавм = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(30).call(this.frame_30).wait(1)
    );
  ...
  (lib.вака = function (mode, startPosition, loop) {
    ...
    lib.вака,
    new cjs.Rectangle(0, 0, 16.8, 38.6),
    null
  );
  ...
  (lib.pers8 = function (mode, startPosition, loop) {
    ...
    lib.pers8,
    new cjs.Rectangle(0, 0, 64.6, 91.1),
    null
  );
  ...
  (lib.pers2 = function (mode, startPosition, loop) {
    ...
    lib.pers2,
    new cjs.Rectangle(0, 0, 70.8, 91.9),
    null
  );
  ...
  (lib.pers1_Layer_12 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ x: 49.7, y: 14.8 }, 9, cjs.Ease.quadInOut)
        .to({ x: 54.2, y: 6.2 }, 10, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.pers1_Layer_9 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ regX: 8.3, skewX: -3.5711, x: 8.35 }, 9, cjs.Ease.quadInOut)
        .to({ regX: 8.4, skewX: 3.5711, x: 8.4 }, 10, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.leg1 = function (mode, startPosition, loop) {
    ...
    lib.leg1,
    new cjs.Rectangle(0, 0, 29.1, 27.5),
    null
  );
  ...
  (lib.hzhzhzhz = function (mode, startPosition, loop) {
    ...
    lib.hzhzhzhz,
    new cjs.Rectangle(0, 0, 38.9, 32.4),
    null
  );
  ...
  (lib.hjsgdfjhgsdhvj_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleY: 1.0121, skewX: -8.0917, y: 46.55 }, 14)
        .to({ scaleY: 1, skewX: 0, y: 46.5 }, 15)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.hfgjhfg_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleX: 1.0045, skewY: 5.4329, y: 16.25 }, 6)
        .to({ scaleX: 1.0048, skewY: -5.5802, y: 16.3 }, 6)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.hfgjhfg = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(12).call(this.frame_12).wait(1)
    );
  ...
  (lib.head = function (mode, startPosition, loop) {
    ...
    lib.head,
    new cjs.Rectangle(0, 0, 21.3, 44.3),
    null
  );
  ...
  (lib.hand2 = function (mode, startPosition, loop) {
    ...
    lib.hand2,
    new cjs.Rectangle(-0.3, 0, 14.200000000000001, 15.4),
    null
  );
  ...
  (lib.hand1 = function (mode, startPosition, loop) {
    ...
    lib.hand1,
    new cjs.Rectangle(-1.7, 0.5, 12.299999999999999, 14),
    null
  );
  ...
  (lib.eecghhhh = function (mode, startPosition, loop) {
    ...
    lib.eecghhhh,
    new cjs.Rectangle(0, 0, 5.3, 22.7),
    null
  );
  ...
  (lib.EDEDEDED_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ rotation: 180, x: 7.4, y: 10.9 }, 9)
        .wait(11)
        .to({ rotation: 355.7647, x: 7.55, y: 11 }, 10)
        .wait(11)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.EDEDEDED = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(40).call(this.frame_40).wait(1)
    );
  ...
  (lib.EDEDEDE_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to(
          { regY: 10.8, scaleX: 0.1342, scaleY: 0.1342, x: 7.45, y: 10.95 },
          19
        )
        .to({ regY: 11, scaleX: 1, scaleY: 1, x: 7.5, y: 11 }, 20)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.EDEDEDE = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(39).call(this.frame_39).wait(1)
    );
  ...
  (lib.dxcdcdc = function (mode, startPosition, loop) {
    ...
    lib.dxcdcdc,
    new cjs.Rectangle(0, 0, 15.7, 23.1),
    null
  );
  ...
  (lib.ddcecede = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(26).call(this.frame_26).wait(1)
    );
  ...
  (lib.dccrvrc_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ regX: 7.8, regY: 11.5, scaleX: 1, scaleY: 1, x: 7.8 }, 14)
        .to(
          { regX: 7.9, regY: 11.4, scaleX: 0.1401, scaleY: 0.1401, x: 7.85 },
          15
        )
        .wait(1)
    );
  ...
  (lib.ccece = function (mode, startPosition, loop) {
    ...
    lib.ccece,
    new cjs.Rectangle(0, 0, 15.6, 23.1),
    null
  );
  ...
  (lib.bodyy = function (mode, startPosition, loop) {
    ...
    lib.bodyy,
    new cjs.Rectangle(0, 0, 89.9, 57.7),
    null
  );
  ...
  (lib.ысывсвсв = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(17).call(this.frame_17).wait(1)
    );
  ...
  (lib.чвсвсвсвс_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance).to({ rotation: 360 }, 94).wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.чвсвсвсвс = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(94).call(this.frame_94).wait(1)
    );
  ...
  (lib.тиствсьтвсвсв_Layer_2 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ rotation: 10.2405, y: 29.25 }, 9, cjs.Ease.quadInOut)
        .to({ rotation: 0, y: 29.2 }, 10, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.всвсвсммм_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ x: 4.6 }, 9, cjs.Ease.quadInOut)
        .to({ x: 14.6 }, 10, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.всвсвсвсв_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ regY: 11.2, scaleX: 1, scaleY: 1 }, 9, cjs.Ease.quadInOut)
        .wait(24)
        .to({ regY: 11, scaleX: 0.0909, scaleY: 0.0909 }, 9)
        .to({ _off: true }, 1)
        .wait(23)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.всвсвсвсв = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(65).call(this.frame_65).wait(1)
    );
  ...
  (lib.амамамама_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleY: 1.0035, skewX: -4.8033, x: 35.5 }, 14, cjs.Ease.quadInOut)
        .to({ scaleY: 1.0014, skewX: 3.0065, x: 35.4 }, 15, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.vrvfcc_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ rotation: 360 }, 29, cjs.Ease.quadInOut)
        .wait(31)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.vrvfcc = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(59).call(this.frame_59).wait(1)
    );
  ...
  (lib.upbody_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#5FD5FA")
      .s()
      .p("Aimg0IC/iVIAmBLIAAACIABAAIBnDFIi8CBg");
  ...
  (lib.upbody = function (mode, startPosition, loop) {
    ...
    lib.upbody,
    new cjs.Rectangle(7.9, 9.4, 38, 58.4),
    null
  );
  ...
  (lib.pesr4anim_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleY: 1.0101, skewX: -8.0947 }, 15, cjs.Ease.quadInOut)
        .to({ scaleY: 1.006, skewX: 6.2678 }, 14, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.pers8_anim_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleY: 1.006, skewX: 6.2678 }, 15, cjs.Ease.quadInOut)
        .to({ scaleY: 1.0101, skewX: -8.0947 }, 14, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.pers7_Layer_2 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ rotation: -11.2587, x: 45.1 }, 17)
        .to({ rotation: 8.1935, x: 45.05 }, 18)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.pers6_Layer_2 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ regY: 10, rotation: 14.9992, y: 26.55 }, 5)
        .to({ regY: 10.1, rotation: -6.2539, y: 26.65 }, 5)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.pers6 = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(10).call(this.frame_10).wait(1)
    );
  ...
  (lib.pers5 = function (mode, startPosition, loop) {
    ...
    lib.pers5,
    new cjs.Rectangle(0, 0, 52.8, 71.8),
    null
  );
  ...
  (lib.pers1_upbody = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        ...
        .to(
          { regX: 19.4, scaleX: 1, scaleY: 1.0036, skewX: -4.8102, x: 19.4 },
          10,
          cjs.Ease.quadInOut
        )
        .wait(1)
  ...
  (lib.pers1_leg2 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleY: 1.0033, skewX: -4.6053, x: 53.4 }, 9, cjs.Ease.quadInOut)
        .to({ scaleY: 1.0027, skewX: 4.1881, x: 53.35 }, 10, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.pers1_leg1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to(
          { scaleX: 1.1546, scaleY: 1, skewX: 0, x: 68.85 },
          9,
          cjs.Ease.quadInOut
        )
        .to(
          { scaleX: 0.9655, scaleY: 1.0047, skewX: 5.5612, x: 68.95 },
          10,
          cjs.Ease.quadInOut
        )
        .wait(1)
  ...
  (lib.pers1_Layer_11 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ rotation: -24.7181, x: 42.95, y: 34.1 }, 9, cjs.Ease.quadInOut)
        .to({ rotation: 0, x: 41.3, y: 22.4 }, 10, cjs.Ease.quadInOut)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.pers1__22 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to(
          { regX: 1.7, regY: 10.2, rotation: 67.9877, x: 31.65, y: 30.85 },
          9,
          cjs.Ease.quadInOut
        )
        .to(
          { regX: 1.6, regY: 10.6, rotation: 0, x: 33.3, y: 30.65 },
          10,
          cjs.Ease.quadInOut
        )
        .wait(1)
  ...
  (lib.kjbdckjbdc_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ regY: 11.7, scaleX: 0.0513, scaleY: 0.0513, y: 11.55 }, 10)
        .to({ regY: 11.5, scaleX: 1, scaleY: 1, y: 11.5 }, 10)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.kjbdckjbdc = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(20).call(this.frame_20).wait(1)
    );
  ...
  (lib.jump_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .wait(15)
        .to({ regY: 58.6, scaleY: 0.9444, y: 61.9 }, 5)
        .to({ regY: 58.5, scaleY: 1, y: 38.5 }, 4)
        .to({ regY: 58.6, scaleY: 0.9615, y: 60.9 }, 4, cjs.Ease.get(1))
        .to({ regY: 58.5, scaleY: 1, y: 58.5 }, 2)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.hvgjhvjhv_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ skewX: -2.3923, x: 26.45 }, 14)
        .to({ skewX: 2.3923, x: 26.4 }, 15)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.Scene_1_Isolation_Mode = function (mode, startPosition, loop) {
    ...
    this.instance_2.setTransform(319.95, 276.6, 1, 1, 0, 0, 0, 14.6, 11.5);

    this.instance_3 = new lib.рисорвисорв();
    this.instance_3.parent = this;
    this.instance_3.setTransform(146, 299.4, 1, 1, 0, 0, 0, 14.3, 11.2);

    this.instance_4 = new lib.амамамама();
    this.instance_4.parent = this;
    this.instance_4.setTransform(125, 361.9, 1, 1, 0, 0, 0, 35.4, 47.6);
    ...
    this.instance_6.setTransform(182.1, 352.9, 1, 1, 0, 0, 0, 2.1, 9.4);
    ...
    this.instance_13.setTransform(271.05, 388.7, 1, 1, 0, 0, 0, 2.6, 11.3);

    this.instance_14 = new lib.EDEDEDFFFG();
    this.instance_14.parent = this;
    this.instance_14.setTransform(294, 337.25, 1, 1, 0, 0, 0, 7.4, 11);

    this.instance_15 = new lib.EDEDEDED();
    this.instance_15.parent = this;
    this.instance_15.setTransform(87.95, 308.7, 1, 1, 0, 0, 0, 7.5, 11);

    this.instance_16 = new lib.EDEDEDE();
    this.instance_16.parent = this;
    this.instance_16.setTransform(217.3, 283.55, 1, 1, 0, 0, 0, 7.5, 11);

    this.instance_17 = new lib.ddcecede();
    this.instance_17.parent = this;
    this.instance_17.setTransform(483.75, 354.9, 1, 1, 0, 0, 0, 2.2, 9.3);

    this.instance_18 = new lib.dccrvrc();
    this.instance_18.parent = this;
    this.instance_18.setTransform(473.05, 274.1, 1, 1, 0, 0, 0, 7.8, 11.5);

    this.instance_19 = new lib.kjbdckjbdc();
    this.instance_19.parent = this;
    this.instance_19.setTransform(386.1, 262.55, 1, 1, 0, 0, 0, 7.8, 11.5);
    ...
    this.instance_22.setTransform(350.45, 349.95, 1, 1, 0, 0, 0, 45, 58.5);

    this.instance_23 = new lib.pers8_anim();
    this.instance_23.parent = this;
    this.instance_23.setTransform(434.45, 322.7, 1, 1, 0, 0, 0, 32.2, 45.5);
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AlgIdIAAw4IFsAAQBBgBA6AOQA5AOApAgQApAfAXA2QAWA1AABMQAABZgpA+QgoA+hSAYIAAADQBbAMA1BAQA1BCAABsQAABBgRA4QgRA5goAsQgpArg/AZQhAAbhgAAgAiGF8IBVAAQBOAAAwgjQAxgjAAhdQAAgvgNggQgNgggWgRQgWgUgegHQgdgHglgBIheAAgAiGhgIA+AAQBaAAAqggQApghAAhNQAAhOglgfQgngghQAAIhPAAg"
      );
    this.shape.setTransform(203.925, 340.35);
    ...
    this.instance_27.setTransform(465.95, 410.25, 1, 1, 0, 0, 0, 14.5, 4);

    this.instance_28 = new lib.Group_23();
    this.instance_28.parent = this;
    this.instance_28.setTransform(402.1, 410.25, 1, 1, 0, 0, 0, 14.5, 4);

    this.instance_29 = new lib.Group_24();
    this.instance_29.parent = this;
    this.instance_29.setTransform(353.4, 410.25, 1, 1, 0, 0, 0, 23.5, 4);

    this.instance_30 = new lib.Group_25();
    this.instance_30.parent = this;
    this.instance_30.setTransform(287, 410.25, 1, 1, 0, 0, 0, 33, 4);

    this.instance_31 = new lib.Group_26();
    this.instance_31.parent = this;
    this.instance_31.setTransform(204.65, 410.25, 1, 1, 0, 0, 0, 39, 4);

    this.instance_32 = new lib.Group_27();
    this.instance_32.parent = this;
    this.instance_32.setTransform(120.75, 410.25, 1, 1, 0, 0, 0, 30.5, 4);
    ...
    this.shape_1.graphics
      .f("#F2F2F2")
      .s()
      .p("ADCIdIgyjlIkfAAIgyDlIjjAAIEew4IENAAIEeQ4gAhpCGIDTAAIhpnlIgCAAg");
    this.shape_1.setTransform(433.525, 340.35);

    this.shape_2 = new cjs.Shape();
    this.shape_2.graphics
      .f("#F2F2F2")
      .s()
      .p("AhsIdIAAuFIjsAAIAAizIKxAAIAACzIjsAAIAAOFg");
    this.shape_2.setTransform(360.425, 340.35);
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        ""
      );
    this.shape_3.setTransform(117.65, 340.125);
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AjWIgIgTgBIgWgCIgjgDIAAilQAgAEAgAAQA1AAAYgcQAZgcAVgwIAKgYIkpsXIDzAAICeITICZoTIDjAAIkEMIQgaBVgbA6QgbA8gjAkQggAlgzARQgyARhLAAg"
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AlSIdIAAw4IF8AAQBUAAA4AbQA5AdAjAtQAjAtAPA7QAPA8AAA7QAABUgZA9QgZA+gtAmQgtAog/AUQg/AThNAAIh0AAIAAGwgAh4gzIBhAAQBAABAognQAogoAAhUQAAhQgjgsQgjgqhQAAIhbAAg"
      );
    ...
    this.shape_7.graphics
      .f("#F2F2F2")
      .s()
      .p("ACKIdIjdm8IhRB6IAAFCIjaAAIAAw4IDaAAIAAGwIADAAIESmwIDtAAIkmHPIFHJpg");
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        ""
      );
  ...
  (lib.pres6anim_Layer_1 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .to({ scaleY: 1.0005, skewX: 1.782 }, 14)
        .to({ scaleY: 1, skewX: 0 }, 15)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.Scene_1_Layer_2 = function (mode, startPosition, loop) {
    ...
    this.instance.parent = this;
    this.instance.setTransform(236.1, 410.25, 1, 1, 0, -0.327, 0, 28.5, 96.4);

    this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
  }).prototype = getMCSymbolPrototype(lib.Scene_1_Layer_2, null, null);

  // stage content:
  (lib.logo_square = function (mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {});
    ...
    this.Isolation_Mode.setTransform(274.2, 220.8, 1, 1, 0, 0, 0, 274.2, 220.8);
    ...
    this.Layer_2.name = "Layer_2";
    this.Layer_2.parent = this;
    this.Layer_2.setTransform(235.8, 362.1, 1, 1, 0, 0, 0, 235.8, 362.1);
    this.Layer_2.depth = 0;
    this.Layer_2.isAttachedToCamera = 0;
    this.Layer_2.isAttachedToMask = 0;
    this.Layer_2.layerDepth = 0;
    ...
    this.Layer_3.setTransform(286.8, 340.4, 1, 1, 0, 0, 0, 286.8, 340.4);
  ...
  p.nominalBounds = new cjs.Rectangle(303.4, 278.8, 227.80000000000007, 135.5);
  // library properties:
  lib.properties = {
